/**
* This BasicStat program to get numbers amount less than or equal 10 numbers to sort and find minimum, maximum, average, median
...
public class BasicStat{
    public static void main(String[] args) {
        ...
        String input_num = input_user.nextLine(); // input with scanner (string)
