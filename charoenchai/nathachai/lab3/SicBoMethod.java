/**
* This SicBoMethod program will be give you 2 options, option 1 is choose high or low numbers and option 2 is choose number between 1-6
...
public class SicBoMethod {   
    ...
    static void getChoice(){ // getChoice method
        ...
        int check_choice;
        check_choice = input.nextInt();
        if (check_choice == 1 || check_choice == 2) { // if input is 1 or 2
            choice = check_choice;
        }
        else {
    ...
    static void playGame(){ // playGame method
        ...
        if (check_choice == 1){ // User choose Type 1
            ...
            String hl_input = input.next(); // Read user input "l" "h" or other
            ...
            else if(hl_input.equalsIgnoreCase("l")){
                System.out.println("Dice 1 : "+ dice1 +", Dice 2 : "+ dice2 +", Dice 3 : "+ dice3 ); // Output result 3 dice
                System.out.println("Total is "+total); // Output total dice of 3
            ...
            String num_input = input.next(); // Read user input
