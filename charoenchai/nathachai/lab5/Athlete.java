...
public class Athlete implements Serializable {
    ...
    public Athlete(String name, double weight, double height, Gender gender, String nationality, String birthdate) {
        ...
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy");
        this.dob = LocalDate.parse(birthdate, formatter);
    ...
    // this is override using twostring method for this play the name weight height
    // gender nationnality and birthdate.
    @Override
    public String toString() {
        return "Athlete [" + this.name + ", " + this.weight + "kg, " + this.height + "m, " + this.gender + ", "
